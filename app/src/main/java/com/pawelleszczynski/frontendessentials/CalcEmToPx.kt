...
class CalcEmToPx : AppCompatActivity() {
    ...
    {
      output_em_to_px.text = (( BigDecimal(input_text_view1.text.toString().toDouble() * input_text_view2.text.toString().toDouble()).setScale(2,RoundingMode.HALF_EVEN) ).toString())
    }
